...
const STEPS = [
  ...
  },
  {
    ...
    body: "型を横向きにして、両端のコマを支柱のくぼみに載せます。手で1回転させて、振れや引っかかりがないか確認してください。ここまでが型の組立です。",
  },
  {
  ...
  {
    id: "dry", title: "乾かす", photo: "dry.jpg",
    body: "糊と和紙が完全に乾くまで置きます。乾くと紙が張って形が決まります。急がないこと — 生乾きで型を抜くと歪みます。",
  },
  {
    id: "pull", title: "型を抜く", photo: "pull.jpg",
    body: "コマを爪先の側(外向き)へ抜き、羽根板を開口から1枚ずつ引き出します。羽根板の内側は中央がえぐってあるので、開口より小さくなって抜けます。",
  },
  {
    id: "rings", title: "口輪をはめる", fig: "rings", stl: true,
    body: "上下の開口に口輪を入れて真円を保ちます。はみ出した和紙は開口の縁で切り揃えてください。下の口輪には脚を挿すソケットが付いています(設計で切ってある場合)。",
  },
  {
