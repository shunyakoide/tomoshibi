...
/**
 * A draggable dimension handle on the drawing. `key` names the design field it edits (so the
 * inspector row and the handle highlight together), and `axis` which way the drag counts.
 */
type Handle = {
