/**
 * Opening ring: like the washi, part of the finished LANTERN rather than of the mold, which is why
 * it sits here and not in 骨組み. The hoop is sized from the opening and has nothing to set; the
 * bottom one's leg sockets do.
 */
