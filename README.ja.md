...
- **段ボールルート** — 3Dプリンタが無くてもつくれます。原寸 A4 のページを印刷して段ボールから切り出します。
...
2. 上下の開口に口輪をはめる（羽根板の外側にすっと入る）。組み上がりを土台に載せる。
3. 外縁の溝に竹ひごを巻き、その上から和紙を糊で貼る。端の被せ代は口輪に折り返す。
4. 乾かしてから、コマを（爪の側へ）抜き、羽根板を開口から抜き出す。口輪は提灯に残る。
5. 自分で用意した灯りを付ける。
